...
namespace ML.NET_test.Tokenizer
{
    public class WordTokenizer
    {
        ...
        public WordTokenizer(List<string> vocabulary)
        {
        ...
        public static WordTokenizer FromVocabularyFile(string path)
        {
            ...
            return new WordTokenizer(vocabulary);
        }

        public List<(string Token, int VocabularyIndex, int WordIndex, string Word)> Tokenize(params string[] texts)
        {
            // Sentence example: "[CLS] Words of sentence 1[SEP] Words of sentence 2[SEP]"
